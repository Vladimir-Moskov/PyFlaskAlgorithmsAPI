"""
    FactorialAPI - middle layer / interface which expose / map
...
class FactorialAPI(Resource):
    """
        Flask-Restful class for Factorial algorithms http request handling
    """

    def __init__(self, **kwargs) -> None:
        self.strategy = kwargs["strategy"]

    def get(self) -> Tuple[Dict[str, str], int, Dict[str, str]]:
        """
            Apply specific implementasion of Factorial algorithm (as self.strategy)
